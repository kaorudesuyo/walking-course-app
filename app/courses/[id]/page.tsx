      ...
      <div style={{maxWidth:800,margin:"0 auto",padding:"clamp(2.5rem,6vw,5rem) clamp(1.2rem,5vw,4rem) 80px"}}>
        <div className="anim-fade-up" style={{marginBottom:48}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}>
            ...
            {course.bestTime.map(t=><span key={t} style={{fontFamily:"'Jost',sans-serif",fontSize:"0.68rem",color:"var(--muted)",letterSpacing:"0.1em"}}>{BEST_TIME_LABELS[t]?.replace(/^.+? /,"")}</span>)}
          </div>
        </div>
